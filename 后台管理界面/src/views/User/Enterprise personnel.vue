<template>
  <section class="app-container">
    ...
    <el-table :data="users"
      ...
      <!-- <el-table-column prop="update" label="更新时间" min-width="110">
      </el-table-column> -->
    ...
    <el-dialog :title="textMap[dialogStatus]"
      ...
      <el-form :model="editForm"
        ...
        <!-- <el-form-item label="院系" prop="name">
          <el-input v-model="editForm.yuanxi" auto-complete="off"></el-input>
        </el-form-item> -->
