<template>
  <el-menu class="navbar"
           mode="horizontal">
    <nx-hamburger class="hamburger-container"
                  :toggleClick="toggleSideBar"
                  :isActive="sidebar.opened"></nx-hamburger>
    ...
    <div class="right-menu">
      ...
      <nx-github style="margin-top:2px"
                 class="nx-help right-menu-item"></nx-github>
      <!-- <error-log class="errLog-container right-menu-item"></error-log> -->
      <nx-help class="nx-help right-menu-item" />
      <nx-top-lock style="cursor:pointer"
                   class="nx-help"></nx-top-lock>
      ...
      <el-dropdown class="avatar-container right-menu-item"
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <!-- <a target='_blank'
             href="https://github.com/mgbq/nx-admin/"> -->
          <el-dropdown-item>
