    ...
    <el-dialog :title="textMap[dialogStatus]"
      ...
      <el-form :model="editForm"
        ...
        <el-form-item label="适配类型">
          <el-radio-group v-model="editForm.sex">
            <el-radio class="radio"
                      :label=0>安卓企业版</el-radio>
            <el-radio class="radio"
                      :label=1>安卓学生版</el-radio>
            <el-radio class="radio"
                      :label=2>ios企业版</el-radio>
            <el-radio class="radio"
                      :label=3>ios学生版</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="内容"
                      prop="4">
          <el-input v-model="editForm.dd"
                    auto-complete="off">
          </el-input>
        </el-form-item>

        <el-form-item label="ios界面">
          <el-radio-group v-model="editForm.hex">
            <el-radio class="radio"
                      :label=0>打开</el-radio>
            <el-radio class="radio"
                      :label=1>关闭</el-radio>
        ...
        <el-form-item label="强制更新?">
          <el-radio-group v-model="editForm.GX">
            <el-radio class="GX"
                      :label="0">是</el-radio>
            <el-radio class="GX"
                      :label="1">否</el-radio>
