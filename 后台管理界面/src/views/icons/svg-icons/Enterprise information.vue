<template>
  <section class="app-container">
    ...
    >
      ...
      <el-table-column prop="birth" label="简称" width="80"> </el-table-column>

      <el-table-column prop="sex" label="认证状态" width="80">
      </el-table-column>
      <!-- <el-table-column prop="age" label="是否热门" width="120">
      </el-table-column -->
      <el-table-column prop="rm" label="营业执照" width="80"></el-table-column>

      <el-table-column prop="addr" label="推荐" min-width="120">
      </el-table-column>
      <el-table-column prop="birth" label="职位数量" width="120">
      </el-table-column>
      </el-table-column>
      <el-table-column prop="birth" label="hr姓名" width="100">
      </el-table-column>
       </el-table-column>
      <el-table-column prop="birth" label="hr手机" width="100">
      </el-table-column>
        </el-table-column>
      <el-table-column prop="birth" label="邮箱" width="120">
      </el-table-column>
        </el-table-column>
      ...
      >
        ...
        <el-form-item label="性质">
          <el-radio-group v-model="editForm.sx">
            <el-radio class="radio" :label="1">国有企业</el-radio>
            <el-radio class="radio" :label="2">私有企业</el-radio>
            <el-radio class="radio" :label="3">集体企业</el-radio>
            <el-radio class="radio" :label="4">有限责任公司</el-radio>
            <el-radio class="radio" :label="5">上市公司</el-radio>
            <el-radio class="radio" :label="6">私营企业</el-radio>
            <el-radio class="radio" :label="7">中外合资企业</el-radio>
            <el-radio class="radio" :label="8">外商投资企业</el-radio>
           </el-radio-group>
        </el-form-item>
        <!-- <div>
