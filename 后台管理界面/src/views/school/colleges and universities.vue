<template>
  <section class="app-container">
    ...
    <el-table :data="users"
      ...
      <!-- <el-table-column prop="addr" label="更新时间" min-width="160">
      </el-table-column> -->
      ...
      <el-form :model="editForm"
        ...
        <el-form-item label="宣讲类型">
          <el-radio-group v-model="editForm.leix">
            <el-radio class="radio"
                      :label="1">宣讲会+双选会</el-radio>
            <el-radio class="radio"
                      :label="0">线上双选会</el-radio>
            <el-radio class="radio"
                      :label="2">线上宣讲会会</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="认证状态">
          <el-radio-group v-model="editForm.sx">
            <el-radio class="radio"
                      :label="1">已认证</el-radio>
            <el-radio class="radio"
                      :label="2">认证中</el-radio>
            <el-radio class="radio"
                      :label="3">未认证</el-radio>
            <el-radio class="radio"
                      :label="4">认证失败</el-radio>
          </el-radio-group>
        </el-form-item>
